...
By default, Immich Selfie Timelapse can be accessed at `http://[your_server_ip]:5000` or `https://immich_selfie_timelapse.[your_domain].com` if you have [DNS access](../guides/dns-access) configured.
