...
All variables are prepended with the application name, for example, to enable Portainer, you would set `portainer_enabled: true`.
Each application has a number of common variables, for example for Portainer, you can be sure that the following variables exist:
