...
This lets the playbook automatically detect breaking changes, and enables automatic changelog generation.
...
If the commits were rebased, there is no longer a continuous line of commits to read, and thus breaking changes may be missed.
